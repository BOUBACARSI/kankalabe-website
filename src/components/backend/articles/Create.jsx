                            ...
                            <div className='card shadow border-0'>
                                <div className='card-body p-4'>
                                    ...
                                    <div className='d-flex justify-content-between'>
                                        <h4 className='h5'>Créer un article/blog</h4>
                                        <Link to="/admin/articles" className='btn btn-primary'>Retour</Link>
                                    </div>
                                    <hr />
                                    ...
                                    <form onSubmit={handleSubmit(onSubmit)}>
                                        <div className='mb-3'>
                                            <label htmlFor="" className='form-label'>Titre</label>
                                            <input
                                                placeholder='Titre'
                                                {
                                                ...register('title', {
                                        ...
                                        <div className='mb-3'>
                                            <label htmlFor="" className='form-label'>Auteur</label>
                                            <input
                                                placeholder='Auteur'
                                                {
                                                ...register('author')
