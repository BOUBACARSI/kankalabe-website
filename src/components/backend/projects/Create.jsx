                            ...
                            <div className='card shadow border-0'>
                                <div className='card-body p-4'>
                                    ...
                                    <div className='d-flex justify-content-between'>
                                        <h4 className='h5'>Créer un projet</h4>
                                            ...
                                            <div className='col-md-6'>
                                                <div className='mb-3'>
                                                    ...
                                                    <select name="project_category" className='form-control'
                                                        ...
                                                        <option value="Eau">Eau & Énergie</option>
                                                        <option value="Culture">Jeunesse, Sport & Culture</option>
                                                        <option value="Commerce">Commerce & Artisanat</option>
                                                        <option value="Innovation">Numérique & Innovation</option>
