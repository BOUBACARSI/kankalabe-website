...
const BlogDetail = () => {
    ...
    return (
        <>
            ...
            <main>
                <Hero
                    preHeading="Information – Partage – Avenir"
                    heading="Blog, Articles et Nouvelles"
                    text=""
                />
                    ...
                    <div className='container py-5'>
                        <div className='row'>
                            <div className='col-md-8'>
                                <h2>{article.title}</h2>
                                <div className='pb-3'>
                                    par <strong>{article.author}</strong>, le {article.created_at}
                                </div>
                            ...
                            <div className='col-md-4'>
                                <div className='card shadow border-0 sidebar'>
                                    <div className='card-body px-5 py-4'>
                                        <h3 className='mt-2 mb-3'>Dernier article</h3>
                                        {
                                            latestArticles && latestArticles.map((article) => {
                                                return (
                                                    <div className='d-flex border-bottom mb-3 pb-2'>
                                                        <div className='pe-3 pb-2'>
                                                            <Link to={`/blog/${article.id}`}><img width={100} src={`${fileUrl}uploads/articles/small/${article.image}`} alt={article.title} /></Link>
                                                        </div>
